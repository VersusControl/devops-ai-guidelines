...
class Config:
    ...
    CLOUDWATCH_DEFAULT_LOG_GROUP = os.getenv(
        'CLOUDWATCH_DEFAULT_LOG_GROUP',
        '/aws/eks/orders-prod/application',
    )
    ...
    ELASTICSEARCH_DEFAULT_INDEX = os.getenv('ELASTICSEARCH_DEFAULT_INDEX', 'app-logs-*')
    ...
    @classmethod
    def is_elasticsearch_configured(cls) -> bool:
        """Check if Elasticsearch is configured"""
        return bool(cls.ELASTICSEARCH_URL)
