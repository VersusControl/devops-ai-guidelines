...
TOOL_LABELS = {
    ...
    "fetch_all_logs":             "Merging logs from all sources",
    "build_incident_timeline":    "Building incident timeline",
    "find_correlated_events":     "Finding correlated events",
...
def sidebar():
    with st.sidebar:
        ...
        **Cross-source correlation (safe):**
        - `fetch_all_logs` — Merged timeline from all sources
        - `build_incident_timeline` — Time-window clustered view
        - `find_correlated_events` — Events around an anchor
